...
from structural.decorator import Entity, Compressor, EQ
...
class Extra(Toplevel):
    def __init__(self):
        ...
        first = Checkbutton(self, text='Compressor',
                            variable=comp, command=result)
        first.pack()
        second = Checkbutton(self, text='EQ',
                             variable=eq, command=result)
        second.pack()
