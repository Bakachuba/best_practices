...
from behavioral.strategy import CleanSound, KeyScape, VintageSound, Mellotron


# from behavioral.strategy.py import *
...
class Extra(Toplevel):
    def __init__(self):
        ...
        self.button = Button(self, text="Change Sound System",
                             command=partial(self.change_sound_system,
                                             self.mellotron, self.cleanSound))
        self.button.pack(expand=True)

        l = Label(self, text="KeyScape")
        l.pack()
        self.button = Button(self, text="Play Sound", command=
        self.play_keyscape)
        self.button.pack(expand=True)
